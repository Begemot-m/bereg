      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto bg-white">
        ...
        <div className="flex-1 px-4 pb-3 pt-2" style={{ backgroundColor: tint }}>
          ...
          <div className="relative mt-3">
            ...
            <div className="relative overflow-hidden rounded-[12px] bg-white/55 py-1" style={{ border: "var(--bw) solid rgba(32,28,24,.16)", WebkitMaskImage: "linear-gradient(90deg, transparent, #000 16%, #000 84%, transparent)", maskImage: "linear-gradient(90deg, transparent, #000 16%, #000 84%, transparent)" }}>
              <div
                ref={track}
