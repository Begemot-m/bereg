...
export const CLIENTS_HELP: HelpPage[] = [
  {
    title: "Нажмите на плюс",
    text: "Вы можете направить приглашение, чтобы клиент автоматически добавился в ваш список, а вы закрепились за ним. Такой способ синхронизирует все данные, которые клиент будет заполнять. Добавить клиента можно и вручную, но информация будет храниться только у вас.",
