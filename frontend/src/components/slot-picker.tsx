          ...
          {days.map((d) => {
            ...
            return (
              <button
                ...
                className="flex h-[68px] w-14 shrink-0 flex-col items-center justify-center gap-0.5 rounded-[10px] transition-transform duration-150 active:scale-95 stroke"
          ...
          <div className="grid grid-cols-3 gap-2">
            {free.map((s: Slot) => (
              <button
                ...
                className="flex flex-col items-center justify-center gap-0.5 rounded-[8px] py-2.5 text-[14px] font-black transition-transform duration-150 active:scale-95"
