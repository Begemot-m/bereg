        ...
        return (
          <button
            ...
            style={{
              ...
              // цифрой, а обводка повторяет его цвет.
              background: "transparent",
              border: active ? "var(--bw) solid var(--head)" : isToday ? "var(--bw) dashed color-mix(in srgb, var(--edge) 55%, transparent)" : "var(--bw) solid transparent",
            }}
          >
