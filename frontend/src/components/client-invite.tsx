              ...
              <p className="t-cap">
                {days.length
                  ? span === "next"
                    ...
                    : "Семь ближайших дней, куда можно записаться: дни, закрытые вашим правилом «записаться не позже чем за N дней», пропускаются. Окна берутся из графика в момент отправки."
