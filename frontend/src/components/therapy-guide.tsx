...
const Screen = ({ children, tone = "var(--page)" }: { children: React.ReactNode; tone?: string }) => (
  <div className="mx-auto w-[186px] overflow-hidden rounded-[18px] bg-white p-1.5 stroke-lg" style={{ boxShadow: "0 18px 34px -22px rgba(32,28,24,.5)" }}>
    <div className="overflow-hidden rounded-[13px]" style={{ background: tone }}>
      ...
      <div className="min-h-[150px] rounded-t-[10px] bg-[#fffdf7] p-2.5" style={{ borderTop: "1.5px solid rgba(32,28,24,.14)" }}>{children}</div>
    </div>
  </div>
);
  ...
  },
  {
    ...
    illo: (
      <Screen tone="var(--olive-soft)">
        <div className="rounded-[8px] bg-white p-2" style={{ border: "1.5px solid var(--olive-edge)" }}>
