...
const MOOD_BODY_MASK = asset("/mood/character-body-mask.webp");
const MOOD_EYES = asset("/mood/character-eyes.webp");
const MOOD_MOUTHS = [1, 2, 3, 4, 5].map((level) => asset(`/mood/character-mouth-v3-${level}.webp`));
